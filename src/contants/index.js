...
const project2 = [
  {
    name: "Twitter Clone",
    image: twitter,
    github: "https://github.com/Abde-T/twitter_clone",
...
const pj2_features = [
  {
    h1: "User Authentication",
    p: "Secure user authentication system powered by Firebase ensures a safe and personalized experience for each user.",
  },
  {
    h1: "Post Creation and Interaction",
    p: "Users can create and publish posts effortlessly, sharing their thoughts and updates with the community. The platform supports essential features like posting, liking, and commenting, fostering meaningful interactions.",
  },
  {
    h1: "Real-time Updates",
    p: "The application harnesses Firebase's real-time database capabilities, providing users with instant updates on posts, likes, and comments as they happen, creating a dynamic and engaging environment.",
  },
  {
    h1: "Responsive Design",
    p: "Tailwind CSS is employed to ensure a responsive and visually appealing design, adapting seamlessly to various screen sizes and devices.",
  },
];
